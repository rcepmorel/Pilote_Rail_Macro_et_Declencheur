...
#define pinDir                      14   // Direction
#define pinStep                     27   // Signal de PAS (avancement) PWM
#define pinEnable                   25   // Activation du driver/pilote
#define PinIntFinRCL                26   // the number of the pushbutton pin
#define PinIntFinAVNC               33   // the number of the pushbutton pin
...
String strDelaiInterBoucleVP      = "-";
int    intDelaiInterboucleVP      = 0;

String strDistanceEntreCaptureVD  = "-";
int    intDistanceEntreCaptureVD   = 0;

String strDistanceEntreCaptureVR  = "-";
int    intDistanceEntreCaptureVR  = 0;

String strDelaiInterBoucleVR      = "-";
int    intDelaiInterboucleVR      = 0;
...
int intcompteurPasActif           = 0;
int intPasTotalPoseRef            = 0;
String strDirection               = "";
